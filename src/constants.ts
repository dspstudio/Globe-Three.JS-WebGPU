...
export const CONSTANTS = {
  ...
  TEXTURES: {
    ...
    CLOUDS: use2k ? "./2k_earth_clouds.jpg" : "./8k_earth_clouds2.jpg",
  ...
  GUI: {
    ...
    EARTH: {
      ...
      ALBEDO_PBR_MODULATION: 0.35,
      SNOW_MASK_MIN_RGB: 0.35,
      SNOW_MASK_MAX_RGB: 0.52,
      SNOW_MASK_MIN_ALBEDO: 0.40,
      SNOW_MASK_MAX_ALBEDO: 0.60,
      GREEN_DOMINANCE_THRESHOLD: 0.03,
      GIBS_ENABLED: false,
